...
<template>
  <div class="grid grid-cols-5 container mx-auto">
    ...
    <div class="col-span-1 order-2 mb-5 pl-4">
    ...
    <div class="col-span-4 order-1 pr-4 mx-md-0">
      <div id="masonryRow" class="masonryRow flex flex-wrap" ref="masonryRow">
        ...
        <div class="mb-4 w-full sm:w-1/2 lg:w-[33%] news-card px-2 lg:px-3 pb-2 lg:pb-3" v-for="article in News">
          <div style="position: relative">
            ...
            <div v-if="article.categories.length" class="rounded flex absolute bg-[#40454d] top-2.5 left-2.5" style="top: 10px; left: 10px; flex-direction: column; max-width: 100%; max-height: 232.33px; overflow-y: auto;">
                        <div class="d-flex">
      ...
      <div v-if="MoreResults && !loading" class="row d-flex justify-content-center m-3">
        <button class="rounded shadow-sm zoom" type="button" @click="moreGroups()"
          style="border: none; border: 1px solid #dfdfdf; background-color: #ededed; ">
