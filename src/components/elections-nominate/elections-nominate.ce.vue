      ...
      <div class="flex flex-col">
        ...
        <div class="form-group">
          <div class="flex flex-col sm:flex-row gap-x-12">
            ...
            <div class="flex flex-col">
              <h3 class="text-xl mb-0">Nominations Open</h3>
              <p>{nominations_open}</p>
              <h3 class="text-xl mb-0">Nominations Close</h3>
            ...
            <fieldset class="flex flex-col gap-y-1">
              ...
              <div class="input-group flex">
                <input name="item" id="{field_name}" class="form-input" type="text" autocomplete="given-name" {if
                  ...
                  placeholder="Action 1. Action 2. Action 3." {if:elseif field_name=='pronouns' }
                  placeholder="she/her/hers" {/if} value="{field_value}" />
                {if field_save == 1}
                <div class="input-group-append">
                  <button type="submit" aria-label="save" class="btn btn-primary" value="Save">
                    Save
                  </button>
                </div>
                {/if} {if field_view == 1}
              ...
              <div class="form-group">
                ...
                <p class="text-sm">Your manifesto is your primary opportunity to explain to potential voters why they
                  should vote for you.</p>
                {if:elseif field_name == 'manifesto_summary'}
                ...
                <p class="text-sm">Content may look different after saving due to a filtering process that is applied to
                  the content.</p>
                ...
                <div id="crop__modal" class="cropModal" style="display: none;">
                  <div class="cropmodalcontent">
                    ...
                    <p class="closeElectionModalPopup text-end mb-0">
                      <a href="javascript:closeModal();" onclick="closeModal();"
                        id="close-btn-{candidate_id}">&times;</a>
                    </p>
          ...
          <form method="post" id="process-submission">
            ...
            <ul class="pl-0 flex flex-col gap-y-2 mb-2">
              ...
              <!-- <li class="flex items-center gap-x-2">
                ...
                <div class="">
                  <p class="text-sm mb-0">I confirm I have read and agree to the <a target="_blank"
              ...
              <li class="flex items-center gap-x-2">
                ...
                <div class="">
                  <p class="text-sm mb-0">I agree to the collection and publication of my name, pronouns, manifesto
                    information and provided photograph to ensure a fair democratic voting process; and for the sharing
                    of that data, together with my email address, with student media groups for the purposes of
                    organising election events and promotion.</p>
                </div>
              </li>
              <li class="flex items-center gap-x-2">
                <div class="">
            ...
            <button class="btn btn-primary" onclick="javascript:declareSubmission();">Submit</button>
