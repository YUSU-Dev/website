<template>
  <div
    v-show="!toastClosed"
    id="alert-toast"
    class="fixed bottom-20 right-5 z-50 flex w-full max-w-xs items-center space-x-4 divide-x divide-gray-200 rounded-lg bg-white p-4 text-gray-500 shadow-sm rtl:divide-x-reverse dark:divide-gray-700 dark:bg-gray-800 dark:text-gray-400"
    role="alert"
  >
    <div class="flex">
      <div
      ...
      <div class="ms-3 text-sm font-normal">
        ...
        <div class="grid grid-cols-2 gap-2">
          ...
          <div>
            <button
              type="button"
              class="btn btn-secondary w-full px-3 py-2"
              data-dismiss="modal"
              @click="$emit('undo')"
            >
              {{ undoText }}
...
export default {
  ...
  props: {
    ...
    message: {
      type: String,
      default: "You have successfully registered interest.",
    },
    undoText: {
      type: String,
      default: "Undo",
