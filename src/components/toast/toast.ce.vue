<template>
  <div
    v-show="!toastClosed"
    id="alert-toast"
    class="fixed right-5 bottom-20 z-50 flex w-full max-w-xs items-center space-x-4 divide-x divide-gray-200 rounded-lg bg-white p-4 text-gray-500 shadow rtl:divide-x-reverse dark:divide-gray-700 dark:bg-gray-800 dark:text-gray-400"
    role="alert"
  >
    <div class="flex">
      <div
