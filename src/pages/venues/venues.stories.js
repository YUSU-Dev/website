...
export const Courtyard = {
  args: {
    ...
    additional_page_content: `<h2>Additional Information</h2><ul><li>Please note vaping is not permitted inside any York University Students&#39; Union&nbsp;Venue.</li><li>Our staff are mainly your fellow students. Its not fair to be abusive, rude or threatening towards any of our staff. If your behaviour towards our staff is unacceptable you will be asked to leave and may be barred from the premises.</li><li>Whilst we&rsquo;ll do our best to let you know of any changes to our opening hours on our website, we&rsquo;re aware that staff isolating due to Covid-19 could quickly change our ability to open or mean we need to be flexible with our opening hours. If you&rsquo;d like to check on a venue, take a look at our instagram pages</li></ul>`,
  },
};
